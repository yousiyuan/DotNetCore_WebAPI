    ...
    c.fn.extend({
        tableExport: function (l) {
            function R(b) { var a = []; c(b).find("thead").first().find("th").each(function (b, e) { void 0 !== c(e).attr("data-field") ? a[b] = c(e).attr("data-field") : a[b] = b.toString() }); return a } function K(b) {
                var a = "undefined" !== typeof b[0].cellIndex, d = "undefined" !== typeof b[0].rowIndex, q = a || d ? ta(b) : b.is(":visible"), k = b.data("tableexport-display"); a && "none" != k && "always" != k && (b = c(b[0].parentNode), d = "undefined" !== typeof b[0].rowIndex, k = b.data("tableexport-display")); d && "none" !=
                    k && "always" != k && (k = b.closest("table").data("tableexport-display")); return "none" !== k && (1 == q || "always" == k)
            } function ta(b) {
                var a = []; M && (a = G.filter(function () { var a = !1; this.nodeType == b[0].nodeType && ("undefined" !== typeof this.rowIndex && this.rowIndex == b[0].rowIndex ? a = !0 : "undefined" !== typeof this.cellIndex && this.cellIndex == b[0].cellIndex && "undefined" !== typeof this.parentNode.rowIndex && "undefined" !== typeof b[0].parentNode.rowIndex && this.parentNode.rowIndex == b[0].parentNode.rowIndex && (a = !0)); return a })); return 0 ==
                    M || 0 == a.length
            } function da(b, e, d) { var q = !1; K(b) ? 0 < a.ignoreColumn.length && (-1 != c.inArray(d, a.ignoreColumn) || -1 != c.inArray(d - e, a.ignoreColumn) || L.length > d && "undefined" != typeof L[d] && -1 != c.inArray(L[d], a.ignoreColumn)) && (q = !0) : q = !0; return q } function y(b, e, d, q, k) {
                if ("function" === typeof k) {
                    var g = !1; "function" === typeof a.onIgnoreRow && (g = a.onIgnoreRow(c(b), d)); if (!1 === g && -1 == c.inArray(d, a.ignoreRow) && -1 == c.inArray(d - q, a.ignoreRow) && K(c(b))) {
                        var w = c(b).find(e), t = 0; w.each(function (b) {
                            var a = c(this), e, q = 1, g =
                                1, C = w.length; if ("undefined" != typeof B[d] && 0 < B[d].length) { var f = b; for (e = 0; e <= f; e++)"undefined" != typeof B[d][e] && (!1 === da(a, C, b + t) && k(null, d, e), delete B[d][e], f++); b += B[d].length; C += B[d].length } a.is("[colspan]") ? (q = parseInt(a.attr("colspan")) || 1, t += 0 < q ? q - 1 : 0) : a.is("[rowspan]") && (g = parseInt(a.attr("rowspan")) || 1); if (!1 === da(a, C, b + t)) for (k(this, d, b), e = 1; e < q; e++)k(null, d, b + e); if (1 < g) for (a = 1; a < g; a++)for ("undefined" == typeof B[d + a] && (B[d + a] = []), B[d + a][b + t] = "", e = 1; e < q; e++)B[d + a][b + t - e] = ""
                        }); if ("undefined" !=
                    ...
                    if (b.url) {
                        var d = new Image; c = ++g; d.crossOrigin = "Anonymous"; d.onerror = d.onload = function () {
                            if (d.complete && (0 === d.src.indexOf("data:image/") && (d.width = b.width || d.width || 0, d.height =
                                b.height || d.height || 0), d.width + d.height)) { var e = document.createElement("canvas"), q = e.getContext("2d"); e.width = d.width; e.height = d.height; q.drawImage(d, 0, 0); b.src = e.toDataURL("image/jpeg") } --g || a(c)
                        }; d.src = b.url
                    }
                        ...
                        "" : ""; else if (g = k.html(), "function" === typeof a.onCellHtmlData) g = a.onCellHtmlData(k, e, d, g); else if ("" != g) { b = c.parseHTML(g); var f = 0, t = 0; g = ""; c.each(b, function () { if (c(this).is("input")) g += k.find("input").eq(f++).val(); else if (c(this).is("select")) g += k.find("select option:selected").eq(t++).text(); else if ("undefined" === typeof c(this).html()) g += c(this).text(); else if (void 0 === jQuery().bootstrapTable || !0 !== c(this).hasClass("filterControl")) g += c(this).html() }) } if (!0 === a.htmlContent) q = c.trim(g); else if (g &&
                            "" != g) {
                                var h = g.replace(/\n/g, "\u2028").replace(/<br\s*[\/]?>/gi, "\u2060"), l = c("<div/>").html(h).contents(); b = !1; h = ""; c.each(l.text().split("\u2028"), function (b, a) { 0 < b && (h += " "); h += c.trim(a) }); c.each(h.split("\u2060"), function (b, a) { 0 < b && (q += "\n"); q += c.trim(a).replace(/\u00AD/g, "") }); if ("json" == a.type || "excel" === a.type && "xmlss" === a.excelFileFormat || !1 === a.numbers.output) b = X(q), !1 !== b && (q = Number(b)); else if (a.numbers.html.decimalMark != a.numbers.output.decimalMark || a.numbers.html.thousandsSeparator !=
                                    a.numbers.output.thousandsSeparator) if (b = X(q), !1 !== b) { l = ("" + b.substr(0 > b ? 1 : 0)).split("."); 1 == l.length && (l[1] = ""); var m = 3 < l[0].length ? l[0].length % 3 : 0; q = (0 > b ? "-" : "") + (a.numbers.output.thousandsSeparator ? (m ? l[0].substr(0, m) + a.numbers.output.thousandsSeparator : "") + l[0].substr(m).replace(/(\d{3})(?=\d)/g, "$1" + a.numbers.output.thousandsSeparator) : l[0]) + (l[1].length ? a.numbers.output.decimalMark + l[1] : "") }
                        } !0 === a.escape && (q = escape(q)); "function" === typeof a.onCellData && (q = a.onCellData(k, e, d, q))
                } return q
            } function va(b,
                a, d) { return a + "-" + d.toLowerCase() } function S(b, a) { var d = /^rgb\((\d{1,3}),\s*(\d{1,3}),\s*(\d{1,3})\)$/.exec(b), e = a; d && (e = [parseInt(d[1]), parseInt(d[2]), parseInt(d[3])]); return e } function la(a) {
                    var b = I(a, "text-align"), d = I(a, "font-weight"), q = I(a, "font-style"), k = ""; "start" == b && (b = "rtl" == I(a, "direction") ? "right" : "left"); 700 <= d && (k = "bold"); "italic" == q && (k += q); "" === k && (k = "normal"); b = {
                        style: { align: b, bcolor: S(I(a, "background-color"), [255, 255, 255]), color: S(I(a, "color"), [0, 0, 0]), fstyle: k }, colspan: parseInt(c(a).attr("colspan")) ||
                            0, rowspan: parseInt(c(a).attr("rowspan")) || 0
                    }; null !== a && (a = a.getBoundingClientRect(), b.rect = { width: a.width, height: a.height }); return b
            ...
            function H(a) {
                ...
                consoleLog: !1, csvEnclosure: '"', csvSeparator: ",", csvUseBOM: !0, displayTableName: !1, escape: !1, excelFileFormat: "xlshtml", excelRTL: !1, excelstyles: [], fileName: "tableExport", htmlContent: !1, ignoreColumn: [], ignoreRow: [], jsonScope: "all", jspdf: {
                    orientation: "p", unit: "pt",
                ...
                n = 0; var v = "INSERT INTO `" + a.tableName + "` ("; p = c(u).find("thead").first().find(a.theadSelector); p.each(function () {
                    y(this, "th,td", n, p.length, function (a, c, d) {
                        v += "'" +
                        x(a, c, d) + "',"
                    }); n++; v = c.trim(v); v = c.trim(v).substring(0, v.length - 1)
                ...
                var N = []; p = c(u).find("thead").first().find(a.theadSelector); p.each(function () { var a = []; y(this, "th,td", n, p.length, function (b, d, c) { a.push(x(b, d, c)) }); N.push(a) }); var aa = []; c(u).find("tbody").each(function () { h.push.apply(h, c(this).find(a.tbodySelector)) }); a.tfootSelector.length &&
                    h.push.apply(h, c(u).find("tfoot").find(a.tfootSelector)); c(h).each(function () { var a = {}, e = 0; y(this, "td,th", n, p.length + h.length, function (b, c, k) { N.length ? a[N[N.length - 1][e]] = x(b, c, k) : a[e] = x(b, c, k); e++ }); !1 === c.isEmptyObject(a) && aa.push(a); n++ }); l = ""; l = "head" == a.jsonScope ? JSON.stringify(N) : "data" == a.jsonScope ? JSON.stringify(aa) : JSON.stringify({ header: N, data: aa }); !0 === a.consoleLog && console.log(l); if ("string" === a.outputMode) return l; if ("base64" === a.outputMode) return H(l); try {
                    z = new Blob([l], { type: "application/json;charset=utf-8" }),
                        saveAs(z, a.fileName + ".json")
                    } catch (b) { D(a.fileName + ".json", "data:application/json;charset=utf-8;base64,", l) }
            } else if ("xml" === a.type) {
                n = 0; var F = '<?xml version="1.0" encoding="utf-8"?>'; F += "<tabledata><fields>"; p = c(u).find("thead").first().find(a.theadSelector); p.each(function () { y(this, "th,td", n, p.length, function (a, c, d) { F += "<field>" + x(a, c, d) + "</field>" }); n++ }); F += "</fields><data>"; var na = 1; c(u).find("tbody").each(function () { h.push.apply(h, c(this).find(a.tbodySelector)) }); a.tfootSelector.length && h.push.apply(h,
                ...
                var ba = []; c(u).filter(function () { return K(c(this)) }).each(function () {
                    var b = c(this), e = ""; G = b.find("tr, th, td").filter(":hidden"); M = 0 < G.length; n = 0; L = R(this); p = b.find("thead").first().find(a.theadSelector); e += "<Table>"; var d = 0; p.each(function () {
                        m = ""; y(this, "th,td", n, p.length, function (a, b, c) { null !== a && (m += '<Cell><Data ss:Type="String">' + x(a, b, c) + "</Data></Cell>", d++) }); 0 < m.length && (e += "<Row>" +
                            m + "</Row>"); n++
                    }); h = []; b.find("tbody").each(function () { h.push.apply(h, c(this).find(a.tbodySelector)) }); c(h).each(function () {
                        m = ""; y(this, "td,th", n, p.length + h.length, function (a, b, d) { if (null !== a) { var c = "String", e = ""; a = x(a, b, d); !1 !== jQuery.isNumeric(a) ? c = "Number" : (b = a, -1 < b.indexOf("%") ? (b = X(b.replace(/%/g, "")), !1 !== b && (b /= 100)) : b = !1, !1 !== b && (a = b, c = "Number", e = ' ss:StyleID="pct1"')); "Number" !== c && (a = a.replace(/\n/g, "<br>")); m += "<Cell" + e + '><Data ss:Type="' + c + '">' + a + "</Data></Cell>" } }); 0 < m.length && (e += "<Row>" +
                            m + "</Row>"); n++
                ...
                for (var A = 0; A < ba.length; A++)l += '<Worksheet ss:Name="' + ("string" === typeof a.worksheetName ? a.worksheetName + " " + (A + 1) : "undefined" !== typeof a.worksheetName[A] ? a.worksheetName[A] : "Table " + (A + 1)) + '" ss:RightToLeft="' + (a.excelRTL ? "1" : "0") + '">' + ba[A], l = a.excelRTL ? l + '<WorksheetOptions xmlns="urn:schemas-microsoft-com:office:excel"> <DisplayRightToLeft/> </WorksheetOptions> ' : l + "<WorksheetOptions/> ", l += "</Worksheet>"; l += "</Workbook>"; !0 === a.consoleLog && console.log(l); if ("string" === a.outputMode) return l; if ("base64" ===
                    a.outputMode) return H(l); try { z = new Blob([l], { type: "application/xml;charset=utf-8" }), saveAs(z, a.fileName + ".xml") } catch (b) { D(a.fileName + ".xml", "data:application/xml;charset=utf-8;base64,", l) }
            } else if ("excel" == a.type || "xls" == a.type || "word" == a.type || "doc" == a.type) {
                l = "excel" == a.type || "xls" == a.type ? "excel" : "word"; A = "excel" == l ? "xls" : "doc"; var r = 'xmlns:x="urn:schemas-microsoft-com:office:' + l + '"', J = ""; c(u).filter(function () { return K(c(this)) }).each(function () {
                    var b = c(this); G = b.find("tr, th, td").filter(":hidden");
                    M = 0 < G.length; n = 0; L = R(this); J += "<table><thead>"; p = b.find("thead").first().find(a.theadSelector); p.each(function () {
                        m = ""; y(this, "th,td", n, p.length, function (b, d, f) {
                            if (null !== b) {
                                var e = ""; m += "<th"; for (var g in a.excelstyles) if (a.excelstyles.hasOwnProperty(g)) { var h = c(b).css(a.excelstyles[g]); "" !== h && "0px none rgb(0, 0, 0)" != h && "rgba(0, 0, 0, 0)" != h && (e += "" === e ? 'style="' : ";", e += a.excelstyles[g] + ":" + h) } "" !== e && (m += " " + e + '"'); c(b).is("[colspan]") && (m += ' colspan="' + c(b).attr("colspan") + '"'); c(b).is("[rowspan]") &&
                                    (m += ' rowspan="' + c(b).attr("rowspan") + '"'); m += ">" + x(b, d, f) + "</th>"
                            }
                        }); 0 < m.length && (J += "<tr>" + m + "</tr>"); n++
                    }); J += "</thead><tbody>"; b.find("tbody").each(function () { h.push.apply(h, c(this).find(a.tbodySelector)) }); a.tfootSelector.length && h.push.apply(h, b.find("tfoot").find(a.tfootSelector)); c(h).each(function () {
                        var b = c(this); m = ""; y(this, "td,th", n, p.length + h.length, function (d, e, f) {
                            if (null !== d) {
                                var g = x(d, e, f), h = "", k = c(d).data("tableexport-msonumberformat"); "undefined" == typeof k && "function" === typeof a.onMsoNumberFormat &&
                    ...
                    }); a.displayTableName && (J += "<tr><td></td></tr><tr><td></td></tr><tr><td>" + x(c("<p>" + a.tableName + "</p>")) + "</td></tr>"); J += "</tbody></table>"; !0 === a.consoleLog && console.log(J)
                }); r = '<html xmlns:o="urn:schemas-microsoft-com:office:office" ' + r + ' xmlns="http://www.w3.org/TR/REC-html40">' + ('<meta http-equiv="content-type" content="application/vnd.ms-' + l + '; charset=UTF-8">') + "<head>"; "excel" ===
                ...
                !0 === a.consoleLog && console.log(r); if ("string" === a.outputMode) return r; if ("base64" === a.outputMode) return H(r); try { z = new Blob([r], { type: "application/vnd.ms-" + a.type }), saveAs(z, a.fileName + "." + A) } catch (b) { D(a.fileName + "." + A, "data:application/vnd.ms-" + l + ";base64,", r) }
            } else if ("xlsx" == a.type) {
                var oa = [], ca = []; n = 0; h = c(u).find("thead").first().find(a.theadSelector); c(u).find("tbody").each(function () { h.push.apply(h, c(this).find(a.tbodySelector)) }); a.tfootSelector.length && h.push.apply(h, c(u).find("tfoot").find(a.tfootSelector));
                c(h).each(function () {
                    var b = []; y(this, "th,td", n, h.length, function (c, d, f) { if ("undefined" !== typeof c && null !== c) { f = x(c, d, f); d = parseInt(c.getAttribute("colspan")); c = parseInt(c.getAttribute("rowspan")); ca.forEach(function (a) { if (n >= a.s.r && n <= a.e.r && b.length >= a.s.c && b.length <= a.e.c) for (var d = 0; d <= a.e.c - a.s.c; ++d)b.push(null) }); if (c || d) d = d || 1, ca.push({ s: { r: n, c: b.length }, e: { r: n + (c || 1) - 1, c: b.length + d - 1 } }); "function" !== typeof a.onCellData && "" !== f && f == +f && (f = +f); b.push("" !== f ? f : null); if (d) for (c = 0; c < d - 1; ++c)b.push(null) } });
                    oa.push(b); n++
                }); l = new Y; A = wa(oa); A["!merges"] = ca; l.SheetNames.push(a.worksheetName); l.Sheets[a.worksheetName] = A; l = XLSX.write(l, { bookType: a.type, bookSST: !1, type: "binary" }); try { z = new Blob([ma(l)], { type: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;charset=UTF-8" }), saveAs(z, a.fileName + "." + a.type) } catch (b) { D(a.fileName + "." + a.type, "data:application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;charset=UTF-8,", ma(l)) }
            } else if ("png" == a.type) html2canvas(c(u)[0]).then(function (b) {
                b =
                b.toDataURL(); for (var c = atob(b.substring(22)), d = new ArrayBuffer(c.length), f = new Uint8Array(d), h = 0; h < c.length; h++)f[h] = c.charCodeAt(h); !0 === a.consoleLog && console.log(c); if ("string" === a.outputMode) return c; if ("base64" === a.outputMode) return H(b); if ("window" === a.outputMode) window.open(b); else try { z = new Blob([d], { type: "image/png" }), saveAs(z, a.fileName + ".png") } catch (g) { D(a.fileName + ".png", "data:image/png,", z) }
            }); else if ("pdf" == a.type) if (!0 === a.pdfmake.enabled) {
                l = []; var pa = []; n = 0; A = function (a, e, d) {
                    var b =
                        0; c(a).each(function () { var a = []; y(this, e, n, d, function (b, d, c) { if ("undefined" !== typeof b && null !== b) { var e = parseInt(b.getAttribute("colspan")), g = parseInt(b.getAttribute("rowspan")); b = x(b, d, c) || " "; 1 < e || 1 < g ? a.push({ colSpan: e || 1, rowSpan: g || 1, text: b }) : a.push(b) } else a.push(" ") }); a.length && pa.push(a); b < a.length && (b = a.length); n++ }); return b
                }; p = c(this).find("thead").first().find(a.theadSelector); r = A(p, "th,td", p.length); for (var qa = l.length; qa < r; qa++)l.push("*"); c(this).find("tbody").each(function () {
                    h.push.apply(h,
                        c(this).find(a.tbodySelector))
                }); a.tfootSelector.length && h.push.apply(h, c(this).find("tfoot").find(a.tfootSelector)); A(h, "th,td", p.length + h.length); l = { content: [{ table: { headerRows: p.length, widths: l, body: pa } }] }; c.extend(!0, l, a.pdfmake.docDefinition); pdfMake.fonts = { Roboto: { normal: "Roboto-Regular.ttf", bold: "Roboto-Medium.ttf", italics: "Roboto-Italic.ttf", bolditalics: "Roboto-MediumItalic.ttf" } }; c.extend(!0, pdfMake.fonts, a.pdfmake.fonts); pdfMake.createPdf(l).getBuffer(function (b) {
                    try {
                        var c = new Blob([b],
                            { type: "application/pdf" }); saveAs(c, a.fileName + ".pdf")
                    } catch (d) { D(a.fileName + ".pdf", "data:application/pdf;base64,", b) }
                })
            } else if (!1 === a.jspdf.autotable) { l = { dim: { w: T(c(u).first().get(0), "width", "mm"), h: T(c(u).first().get(0), "height", "mm") }, pagesplit: !1 }; var ra = new jsPDF(a.jspdf.orientation, a.jspdf.unit, a.jspdf.format); ra.addHTML(c(u).first(), a.jspdf.margins.left, a.jspdf.margins.top, l, function () { ea(ra, !1) }) } else {
                var f = a.jspdf.autotable.tableExport; if ("string" === typeof a.jspdf.format && "bestfit" === a.jspdf.format.toLowerCase()) {
                    var P =
                        { a0: [2383.94, 3370.39], a1: [1683.78, 2383.94], a2: [1190.55, 1683.78], a3: [841.89, 1190.55], a4: [595.28, 841.89] }, W = "", Q = "", sa = 0; c(u).each(function () { if (K(c(this))) { var a = T(c(this).get(0), "width", "pt"); if (a > sa) { a > P.a0[0] && (W = "a0", Q = "l"); for (var e in P) P.hasOwnProperty(e) && P[e][1] > a && (W = e, Q = "l", P[e][0] > a && (Q = "p")); sa = a } } }); a.jspdf.format = "" === W ? "a4" : W; a.jspdf.orientation = "" === Q ? "w" : Q
                ...
                !0 === f.outputImages && (f.images = {}); "undefined" != typeof f.images && (c(u).filter(function () { return K(c(this)) }).each(function () {
                    var b = 0; G = c(this).find("tr, th, td").filter(":hidden"); M = 0 < G.length; p = c(this).find("thead").find(a.theadSelector); c(this).find("tbody").each(function () { h.push.apply(h, c(this).find(a.tbodySelector)) }); a.tfootSelector.length && h.push.apply(h, c(this).find("tfoot").find(a.tfootSelector)); c(h).each(function () {
                        y(this, "td,th", p.length + b, p.length + h.length, function (a) {
                            if ("undefined" !==
                                typeof a && null !== a) { var b = c(a).children(); "undefined" != typeof b && 0 < b.length && ha(a, b, f) }
                        }); b++
                    })
                }), p = [], h = []); ua(f, function () {
                    c(u).filter(function () { return K(c(this)) }).each(function () {
                        var b, e = 0; G = c(this).find("tr, th, td").filter(":hidden"); M = 0 < G.length; L = R(this); f.columns = []; f.rows = []; f.rowoptions = {}; if ("function" === typeof f.onTable && !1 === f.onTable(c(this), a)) return !0; a.jspdf.autotable.tableExport = null; var d = c.extend(!0, {}, a.jspdf.autotable); a.jspdf.autotable.tableExport = f; d.margin = {}; c.extend(!0,
                            d.margin, a.jspdf.margins); d.tableExport = f; "function" !== typeof d.beforePageContent && (d.beforePageContent = function (a) { 1 == a.pageCount && a.table.rows.concat(a.table.headerRow).forEach(function (b) { 0 < b.height && (b.height += (2 - 1.15) / 2 * b.styles.fontSize, a.table.height += (2 - 1.15) / 2 * b.styles.fontSize) }) }); "function" !== typeof d.createdHeaderCell && (d.createdHeaderCell = function (a, b) {
                            a.styles = c.extend({}, b.row.styles); if ("undefined" != typeof f.columns[b.column.dataKey]) {
                                var e = f.columns[b.column.dataKey]; if ("undefined" !=
                                    typeof e.rect) { a.contentWidth = e.rect.width; if ("undefined" == typeof f.heightRatio || 0 === f.heightRatio) { var g = b.row.raw[b.column.dataKey].rowspan ? b.row.raw[b.column.dataKey].rect.height / b.row.raw[b.column.dataKey].rowspan : b.row.raw[b.column.dataKey].rect.height; f.heightRatio = a.styles.rowHeight / g } g = b.row.raw[b.column.dataKey].rect.height * f.heightRatio; g > a.styles.rowHeight && (a.styles.rowHeight = g) } "undefined" != typeof e.style && !0 !== e.style.hidden && (a.styles.halign = e.style.align, "inherit" === d.styles.fillColor &&
                                        (a.styles.fillColor = e.style.bcolor), "inherit" === d.styles.textColor && (a.styles.textColor = e.style.color), "inherit" === d.styles.fontStyle && (a.styles.fontStyle = e.style.fstyle))
                            }
                            }); "function" !== typeof d.createdCell && (d.createdCell = function (a, b) {
                                var c = f.rowoptions[b.row.index + ":" + b.column.dataKey]; "undefined" != typeof c && "undefined" != typeof c.style && !0 !== c.style.hidden && (a.styles.halign = c.style.align, "inherit" === d.styles.fillColor && (a.styles.fillColor = c.style.bcolor), "inherit" === d.styles.textColor && (a.styles.textColor =
                                    c.style.color), "inherit" === d.styles.fontStyle && (a.styles.fontStyle = c.style.fstyle))
                            }); "function" !== typeof d.drawHeaderCell && (d.drawHeaderCell = function (a, b) { var c = f.columns[b.column.dataKey]; return (!0 !== c.style.hasOwnProperty("hidden") || !0 !== c.style.hidden) && 0 <= c.rowIndex ? fa(a, b, c) : !1 }); "function" !== typeof d.drawCell && (d.drawCell = function (a, b) {
                                var c = f.rowoptions[b.row.index + ":" + b.column.dataKey]; if (fa(a, b, c)) if (f.doc.rect(a.x, a.y, a.width, a.height, a.styles.fillStyle), "undefined" != typeof c && "undefined" !=
                                    typeof c.kids && 0 < c.kids.length) { var d = a.height / c.rect.height; if (d > f.dh || "undefined" == typeof f.dh) f.dh = d; f.dw = a.width / c.rect.width; d = a.textPos.y; ja(a, c.kids, f); a.textPos.y = d; ka(a, c.kids, f) } else ka(a, {}, f); return !1
                            }); f.headerrows = []; p = c(this).find("thead").find(a.theadSelector); p.each(function () { b = 0; f.headerrows[e] = []; y(this, "th,td", e, p.length, function (a, c, d) { var g = la(a); g.title = x(a, c, d); g.key = b++; g.rowIndex = e; f.headerrows[e].push(g) }); e++ }); if (0 < e) for (var l = e - 1; 0 <= l;)c.each(f.headerrows[l], function () {
                                var a =
                                    this; 0 < l && null === this.rect && (a = f.headerrows[l - 1][this.key]); null !== a && 0 <= a.rowIndex && (!0 !== a.style.hasOwnProperty("hidden") || !0 !== a.style.hidden) && f.columns.push(a)
                            }), l = 0 < f.columns.length ? -1 : l - 1; var k = 0; h = []; c(this).find("tbody").each(function () { h.push.apply(h, c(this).find(a.tbodySelector)) }); a.tfootSelector.length && h.push.apply(h, c(this).find("tfoot").find(a.tfootSelector)); c(h).each(function () {
                                var a = []; b = 0; y(this, "td,th", e, p.length + h.length, function (d, e, h) {
                                    if ("undefined" === typeof f.columns[b]) {
                                        var g =
                                            { title: "", key: b, style: { hidden: !0 } }; f.columns.push(g)
                                    } "undefined" !== typeof d && null !== d ? (g = la(d), g.kids = c(d).children()) : (g = c.extend(!0, {}, f.rowoptions[k + ":" + (b - 1)]), g.colspan = -1); f.rowoptions[k + ":" + b++] = g; a.push(x(d, e, h))
                                }); a.length && (f.rows.push(a), k++); e++
                            }); if ("function" === typeof f.onBeforeAutotable) f.onBeforeAutotable(c(this), f.columns, f.rows, d); f.doc.autoTable(f.columns, f.rows, d); if ("function" === typeof f.onAfterAutotable) f.onAfterAutotable(c(this), d); a.jspdf.autotable.startY = f.doc.autoTableEndPosY() +
                                d.margin.top
