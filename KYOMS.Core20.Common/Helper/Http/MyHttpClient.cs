...
namespace KYOMS.Core20.Common
{
    public class MyHttpClient
    {
        ...
        /// <param name="UploadText"></param>
        /// <returns></returns>
        public string UploadString(string UploadText,Encoding encode)
        {
            MyWebClient client = new MyWebClient();
            ServicePointManager.DefaultConnectionLimit = DefaultConnectionLimit;
        ...
        /// <returns></returns>
        public async Task<string> UploadStringAsync(string uploadText, Encoding encode)
        {
            ...
            client.Encoding = encode;
            client.Proxy = null;
            var strResult= await client.UploadStringTaskAsync(new Uri(url), uploadText);
            return strResult;
        }
