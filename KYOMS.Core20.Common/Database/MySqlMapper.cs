...
{
    public class MySqlMapper : ISqlMapper
    {
        ...
        public MySqlMapper()
        {
            ...
            try
            {
                string configFile = AppDomain.CurrentDomain.BaseDirectory + (@"config/MySqlSmartSqlMap.config");
                if (mapper == null)
                {
        ...
        public MySqlMapper(string configFile = @"config/MySqlSmartSqlMap.config")
        {
            ...
            try
            {
                ...
                {
                    configFile = AppDomain.CurrentDomain.BaseDirectory + (@"config/MySqlSmartSqlMap.config");
                }
                else
                {
